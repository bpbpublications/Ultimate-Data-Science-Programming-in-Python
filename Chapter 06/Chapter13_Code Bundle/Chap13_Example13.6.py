...
print(f"lower_bound value is {lower_bound}")
print(f"upper_bound value is {upper_bound}")
...
myplt.text(0.1, q1 + 0.1 * iqr, f'IQR: {iqr}', ha='center', va='bottom', color='red')
...
myplt.text(0.1, upper_bound + 2, f'Range (no outliers): {range_without_outliers}', ha='center', va='bottom', color='red')
# Set plot title
